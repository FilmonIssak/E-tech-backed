...
class CustomerControllerTest {
    ...
    void testGetAllProducts() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/api/v1/customer/products");
    ...
    void testGetAllProducts2() throws Exception {
        when(customerService.findAll()).thenReturn(new ArrayList<>());
        MockHttpServletRequestBuilder getResult = MockMvcRequestBuilders.get("/api/v1/customer/products");
